...
void escape(char array_string1[], char array_string2[]);
void escapeinverse(char array_string1[], char array_string2[]);
...
void escape(char a_s1[], char a_s2[])
{
    int i, j;
...
void escapeinverse(char a_s1[], char a_s2[])
{
    int i, j;
    for(i = j = 0; a_s2[i] != '\0'; i++, j++) {
        if(a_s2[i] == '\\') {
